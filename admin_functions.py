...
from utils.sql_commands import select_users, register_user
...
async def start_bot(message: types.Message, state: FSMContext):
    ...
    await message.answer('Привет, Владелец!', reply_markup= nav.mainMenu)


@dp.message_handler(Text(equals='menu'), user_id=ADMINS_ID, state='*')
